...
% Danielson : algorithm to compute the discrete distance map on a 2D image.
%
...
%% Input parsing
assert(nargin > 0, 'Not enough input argument. Danielson takes at least one input argument.');
